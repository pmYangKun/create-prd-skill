...
def main() -> int:
    parser = argparse.ArgumentParser(description="Install the create-prd skill into a Claude skills directory.")
    parser.add_argument("--source", type=Path, default=Path(__file__).resolve().parents[1])
    parser.add_argument("--target", type=Path, default=Path.home() / ".claude" / "skills" / "create-prd")
